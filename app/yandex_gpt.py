...
class YandexGPTClient:
    def __init__(self):
        try:
            ...
            self.model = self.model.configure(temperature=0.6)
    ...
    async def generate_interpretation(self, cards, question):
        try:
            prompt = f"""Ты - опытный таролог и мистический оракул с глубоким пониманием символизма карт Таро. Твоя задача - дать глубокое, подробное и мистическое толкование расклада карт Таро.
            ...
            - Поддерживай таинственный и мудрый тон
            - Будь проницательным и глубоким в толковании
            - Создавай атмосферу мистического откровения

            Ни в коем случае не выходи из роли гадалки таро, не делай никаких примечаний не относящихся к твоей роли.
